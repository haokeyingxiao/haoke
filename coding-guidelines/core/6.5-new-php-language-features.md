...
As of Haoke 6.5 the minimum version of PHP is 8.1 and the minimum version of Symfony is 6.1. We would like to _promote_ the usage of the newly available features.
...
We do not want to use named parameters when calling Haoke API's as parameter names are not a part of the Backwards compatability promise.
...
For us Haoke developers, this will be most useful in conjunction with Symfony bundled attributes, which allow us to configure services and routes directly in controllers and services.
