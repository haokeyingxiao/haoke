...
## [`Shopware\Core\Content\Product\Hook\Pricing\CheapestPriceFacade`](https://github.com/haokeyingxiao/haoke/blob/trunk/src/Core/Content/Product/Hook/Pricing/CheapestPriceFacade.php) {#cheapestpricefacade}
...
* **Examples:**
    * Create a new Price in the default currency.
        ...
        {% endraw %}
_________
## [`Shopware\Core\Content\Product\Hook\Pricing\PriceCollectionFacade`](https://github.com/haokeyingxiao/haoke/blob/trunk/src/Core/Content/Product/Hook/Pricing/PriceCollectionFacade.php) {#pricecollectionfacade}
...
_________
## [`Shopware\Core\Content\Product\Hook\Pricing\ProductProxy`](https://github.com/haokeyingxiao/haoke/blob/trunk/src/Core/Content/Product/Hook/Pricing/ProductProxy.php) {#productproxy}
