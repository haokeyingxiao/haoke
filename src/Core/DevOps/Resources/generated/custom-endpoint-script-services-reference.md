...
## [services.cache (`Shopware\Core\Framework\Adapter\Cache\Script\Facade\CacheInvalidatorFacade`)](https://github.com/haokeyingxiao/haoke/blob/trunk/src/Core/Framework/Adapter/Cache/Script/Facade/CacheInvalidatorFacade.php) {#cacheinvalidatorfacade}
...
* **Examples:**
    ...
    * Build tags if products with a specific property is created and invalidate those tags.
        ...
        {% endraw %}
_________
## [services.writer (`Shopware\Core\Framework\DataAbstractionLayer\Facade\RepositoryWriterFacade`)](https://github.com/haokeyingxiao/haoke/blob/trunk/src/Core/Framework/DataAbstractionLayer/Facade/RepositoryWriterFacade.php) {#repositorywriterfacade}
...
* **Returns** [`Shopware\Core\Framework\DataAbstractionLayer\Event\EntityWrittenContainerEvent`](https://github.com/haokeyingxiao/haoke/blob/trunk/src/Core/Framework/DataAbstractionLayer/Event/EntityWrittenContainerEvent.php)
...
* **Returns** [`Shopware\Core\Framework\Api\Sync\SyncResult`](https://github.com/haokeyingxiao/haoke/blob/trunk/src/Core/Framework/Api/Sync/SyncResult.php)
...
* **Examples:**
    * Update an entity and delete another one with one `sync()` call.
        ...
        {% endraw %}
_________
## [services.response (`Shopware\Core\Framework\Script\Api\ScriptResponseFactoryFacade`)](https://github.com/haokeyingxiao/haoke/blob/trunk/src/Core/Framework/Script/Api/ScriptResponseFactoryFacade.php) {#scriptresponsefactoryfacade}
...
* **Returns** [`Shopware\Core\Framework\Script\Api\ScriptResponse`](https://github.com/haokeyingxiao/haoke/blob/trunk/src/Core/Framework/Script/Api/ScriptResponse.php)
