...
## [services.cart (`Shopware\Core\Checkout\Cart\Facade\CartFacade`)](https://github.com/haokeyingxiao/platform/blob/trunk/src/Core/Checkout/Cart/Facade/CartFacade.php) {#cartfacade}
...
* **Examples:**
    ...
    * Add a relative surcharge to the cart.
        ...
        {% endraw %}
_________
## [`Shopware\Core\Checkout\Cart\Facade\CartPriceFacade`](https://github.com/haokeyingxiao/platform/blob/trunk/src/Core/Checkout/Cart/Facade/CartPriceFacade.php) {#cartpricefacade}
...
* **Examples:**
    * Create a new Price in the default currency.
        ...
        {% endraw %}
_________
## [`Shopware\Core\Checkout\Cart\Facade\ContainerFacade`](https://github.com/haokeyingxiao/platform/blob/trunk/src/Core/Checkout/Cart/Facade/ContainerFacade.php) {#containerfacade}
...
* **Examples:**
    ...
    * Add a relative surcharge to the cart.
        ...
        {% endraw %}
_________
## [`Shopware\Core\Checkout\Cart\Facade\DiscountFacade`](https://github.com/haokeyingxiao/platform/blob/trunk/src/Core/Checkout/Cart/Facade/DiscountFacade.php) {#discountfacade}
...
_________
## [`Shopware\Core\Checkout\Cart\Facade\ErrorsFacade`](https://github.com/haokeyingxiao/platform/blob/trunk/src/Core/Checkout/Cart/Facade/ErrorsFacade.php) {#errorsfacade}
...
* **Returns** [`Shopware\Core\Checkout\Cart\Error\Error`](https://github.com/haokeyingxiao/platform/blob/trunk/src/Core/Checkout/Cart/Error/Error.php) | `null`
...
_________
## [`Shopware\Core\Checkout\Cart\Facade\ItemFacade`](https://github.com/haokeyingxiao/platform/blob/trunk/src/Core/Checkout/Cart/Facade/ItemFacade.php) {#itemfacade}
...
* **Returns** `string`
    ...
    The type of the line-item.
_________
## [`Shopware\Core\Checkout\Cart\Facade\ItemsFacade`](https://github.com/haokeyingxiao/platform/blob/trunk/src/Core/Checkout/Cart/Facade/ItemsFacade.php) {#itemsfacade}
...
* **Examples:**
    * Add and then remove a product line-item from the cart.
        ...
        {% endraw %}
_________
## [`Shopware\Core\Checkout\Cart\Facade\PriceFacade`](https://github.com/haokeyingxiao/platform/blob/trunk/src/Core/Checkout/Cart/Facade/PriceFacade.php) {#pricefacade}
...
* **Examples:**
    * Create a new Price in the default currency.
        ...
        {% endraw %}
_________
## [services.price (`Shopware\Core\Checkout\Cart\Facade\PriceFactory`)](https://github.com/haokeyingxiao/platform/blob/trunk/src/Core/Checkout/Cart/Facade/PriceFactory.php) {#pricefactory}
...
* **Examples:**
    * Create a new Price in the default currency.
        ...
        {% endraw %}
_________
## [`Shopware\Core\Checkout\Cart\Facade\ProductsFacade`](https://github.com/haokeyingxiao/platform/blob/trunk/src/Core/Checkout/Cart/Facade/ProductsFacade.php) {#productsfacade}
...
* **Examples:**
    * Add and then remove a product line-item from the cart.
        ...
        {% endraw %}
_________
## [`Shopware\Core\Checkout\Cart\Facade\StatesFacade`](https://github.com/haokeyingxiao/platform/blob/trunk/src/Core/Checkout/Cart/Facade/StatesFacade.php) {#statesfacade}
