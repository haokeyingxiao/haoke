...
## [services.request (`Shopware\Core\Framework\Routing\Facade\RequestFacade`)](https://github.com/haokeyingxiao/platform/blob/trunk/src/Core/Framework/Routing/Facade/RequestFacade.php) {#requestfacade}
...
* **Returns** `array`
    ...
    request cookies
_________
## [`Shopware\Core\Framework\Script\Facade\ArrayFacade`](https://github.com/haokeyingxiao/platform/blob/trunk/src/Core/Framework/Script/Facade/ArrayFacade.php) {#arrayfacade}
...
_________
## [services.config (`Shopware\Core\System\SystemConfig\Facade\SystemConfigFacade`)](https://github.com/haokeyingxiao/platform/blob/trunk/src/Core/System/SystemConfig/Facade/SystemConfigFacade.php) {#systemconfigfacade}
