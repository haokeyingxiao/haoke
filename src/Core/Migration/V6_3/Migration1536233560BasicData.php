...
class Migration1536233560BasicData extends MigrationStep
{
    ...
    private function createCurrency(Connection $connection): void
    {
        ...
        $connection->insert('currency', ['id' => $EUR, 'iso_code' => 'EUR', 'factor' => 0.1281, 'symbol' => '€', 'position' => 1, 'decimal_precision' => 2, 'created_at' => (new \DateTime())->format(Defaults::STORAGE_DATE_TIME_FORMAT)]);
        ...
        $connection->insert('currency', ['id' => $USD, 'iso_code' => 'USD', 'factor' => 0.1379, 'symbol' => '$', 'position' => 1, 'decimal_precision' => 2, 'created_at' => (new \DateTime())->format(Defaults::STORAGE_DATE_TIME_FORMAT)]);
        ...
        $connection->insert('currency', ['id' => $GBP, 'iso_code' => 'GBP', 'factor' => 0.108, 'symbol' => '£', 'position' => 1, 'decimal_precision' => 2, 'created_at' => (new \DateTime())->format(Defaults::STORAGE_DATE_TIME_FORMAT)]);
