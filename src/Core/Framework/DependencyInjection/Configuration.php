            ...
            ->arrayNode('jwt_key')
                ->children()
                    ...
                    ->scalarNode('private_key_path')
                        ->setDeprecated('haokeyingxiao/core', '6.7.0.0', 'private_key_path is deprecated and will be removed with Haoke 6.7')
                        ->defaultValue('file://%kernel.project_dir%/config/jwt/private.pem')
                    ->end()
                    ->scalarNode('private_key_passphrase')
                        ->setDeprecated('haokeyingxiao/core', '6.7.0.0', 'private_key_passphrase is deprecated and will be removed with Haoke 6.7')
                        ->defaultValue('shopware')
                    ->end()
                    ->scalarNode('public_key_path')
                        ->setDeprecated('haokeyingxiao/core', '6.7.0.0', 'public_key_path is deprecated and will be removed with Haoke 6.7')
