...
class ApiClient
{
    ...
    public function checkForUpdates(): Version
    {
        ...
        try {
            ...
            $github = $this->client->request('GET', 'https://releases.haokeyingxiao.com/changelog/' . $this->determineLatestShopwareVersion() . '.json')->toArray();
    ...
    private function determineLatestShopwareVersion(): string
    {
        ...
        $versions = $this->client->request('GET', 'https://releases.haokeyingxiao.com/changelog/index.json')->toArray();
